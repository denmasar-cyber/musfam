-- ================================================================
-- MUSFAM UNIFIED BOOTSTRAP
-- 1) Current schema, RLS, functions, storage buckets
-- 2) Demo ecosystem seed aligned to the current app feature set
...
-- ================================================================
-- DEMO SEED STARTS HERE
-- Schema above already adds the current feature columns used by the app,
-- and the seed below now fills the newer mission/reward fields too.
-- ================================================================
